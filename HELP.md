...
One person creates the team and sends each new member **two things, separately**:

1. The **invite code** — safe to text or email. It no longer contains the name of the person you care for.
2. The **team key** — generated by the app. Read it down the phone or send it a different way.
